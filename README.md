...
- `binja.get_data_xrefs_to(addr: int) -> list[dict]` — Get cross-references to data address. Returns [{from_function, from_address}, ...]
- `binja.get_data_xrefs_from(addr: int) -> list[dict]` — Get data references from address. Returns [{to_address}, ...]
